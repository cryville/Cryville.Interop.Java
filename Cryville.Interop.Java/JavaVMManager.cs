...
namespace Cryville.Interop.Java {
	...
	public static class JavaVMManager {
		...
		public static void Register(IJniInvoke vm) {
			...
			m_vms.Add(vm);
			if (m_currentVM == null) m_currentVM = vm;
		}

		static readonly List<IJniInvoke> m_vms = new List<IJniInvoke>();
		/// <summary>
		...
		/// </summary>
		public static IJniEnv CurrentEnv => CurrentVM.GetEnv(0x00010006);
	}
}
